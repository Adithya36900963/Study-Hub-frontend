...
export default function Semester() {
  ...
  //Get subjects by regulationId, branchId and semesterId
  useEffect(() => {
  ...
  //Add subject by regulationId, branchId and semesterId
  ...
  //Delete subject by regulationId, branchId and semesterId
  ...
  //Update subject by regulationId, branchId and semesterId
